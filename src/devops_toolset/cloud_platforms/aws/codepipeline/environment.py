...
from devops_toolset.saas_platforms.literals import Literals as CommonLiterals
from devops_toolset.cloud_platforms.aws.codepipeline.literals import Literals as AwsLiterals
from devops_toolset.operating_systems.linux.commands import Commands as LinuxCommands
import devops_toolset.saas_platforms.common
import logging
import os
...
def log_environment_variables(platform_keys: dict):
    ...
    devops_toolset.saas_platforms.common.log_environment_variables(platform_keys)
