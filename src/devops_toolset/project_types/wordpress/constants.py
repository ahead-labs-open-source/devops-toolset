...
class FileNames(object):
    ...
    DEFAULT_FILES_PATH_FROM_PACKAGE_ROOT = "devops_toolset/project_types/wordpress/default_files/"
...
class Urls(object):
    ...
    GITHUB_RAW_CONTENT = "https://raw.githubusercontent.com/ahead-labs-open-source/devops-toolset/main/src/"
    ...
    DEFAULT_PLUGIN_CONFIG = GITHUB_RAW_CONTENT + \
        FileNames.DEFAULT_FILES_PATH_FROM_PACKAGE_ROOT + "default-plugin-config.json"
    DEFAULT_PLUGIN_STRUCTURE = GITHUB_RAW_CONTENT + \
        FileNames.DEFAULT_FILES_PATH_FROM_PACKAGE_ROOT + "default-wordpress-plugin-structure.json"
    DEFAULT_SITE_CONFIG = \
