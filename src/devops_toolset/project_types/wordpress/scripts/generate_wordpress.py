...
def get_basic_paths():
    ...
    default_files_path: pathlib.Path = pathlib.Path.joinpath(wordpress_directory_path, "default_files")
...
if __name__ == "__main__":
    ...
    parser.add_argument("project_path", action=devops_toolset.tools.argument_validators.PathValidator)
