...
from devops_toolset.cloud_platforms.azure import api_management

# region check_apim_exists()


@patch('devops_toolset.cloud_platforms.azure.api_management.cli')
@patch('devops_toolset.cloud_platforms.azure.api_management.logging')
