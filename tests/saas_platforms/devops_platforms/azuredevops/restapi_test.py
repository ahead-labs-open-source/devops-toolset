...
import devops_toolset.saas_platforms.azuredevops.restapi as sut
from devops_toolset.tools.xcoding64 import encode
from tests.saas_platforms.devops_platforms.azuredevops.conftest import mocked_requests_get, mocked_requests_get_ko
from devops_toolset.core.CommandsCore import CommandsCore
from devops_toolset.saas_platforms.azuredevops.commands import Commands as PlatformSpecificCommands
...
@patch("devops_toolset.saas_platforms.azuredevops.restapi.generate_authentication_header")
@patch("logging.info")
...
@patch("devops_toolset.saas_platforms.azuredevops.restapi.call_api")
...
@patch("devops_toolset.saas_platforms.azuredevops.restapi.get_last_build_id")
@patch("devops_toolset.saas_platforms.azuredevops.restapi.get_build")
...
@patch("devops_toolset.saas_platforms.azuredevops.restapi.get_build_list")
...
@patch("devops_toolset.saas_platforms.azuredevops.restapi.get_last_build_id")
@patch("devops_toolset.saas_platforms.azuredevops.restapi.get_artifact")
