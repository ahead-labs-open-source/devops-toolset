...
import pathlib
import devops_toolset.saas_platforms.sonarx as sut
from unittest.mock import patch
from tests.saas_platforms.devops_platforms.conftest import mocked_requests_get
from devops_toolset.core.LiteralsCore import LiteralsCore
from devops_toolset.saas_platforms.literals import Literals as DevopsLiterals
...
@patch("devops_toolset.saas_platforms.sonarx.logging.info")
@patch("devops_toolset.saas_platforms.sonarx.logging.error")
@patch("devops_toolset.saas_platforms.sonarx.read_sonar_properties_file")
@patch("devops_toolset.saas_platforms.sonarx.generate_branch_segment")
